  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "C++", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
        { name: "Ruby", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "Tensorflow", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
        { name: "Huggingface Transformers", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Pandas", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
      ],
    },
    {
      title: "Hardware, embedded and robotics",
      skills: [
        { name: "CAN, TCP/IP", icon: "https://ext.same-assets.com/1282326863/2929177887.png" },
        { name: "ROS2", icon: "https://ext.same-assets.com/1282326863/4264021432.png" },
        { name: "Gazebo", icon: "https://ext.same-assets.com/1282326863/1705279872.png" },
        { name: "Unreal Engine", icon: "https://ext.same-assets.com/1282326863/3841297556.png" },
      ],
    },
    {
      title: "DevOps",
      skills: [
        ...
        { name: "Docker", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
        { name: "Kubeflow", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
        { name: "Gitlab", icon: "https://ext.same-assets.com/1282326863/3388602182.png" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "PyCharm", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
        { name: "CLion", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
        { name: "MATLAB", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
        { name: "Huggingface", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
        { name: "Google Colab", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
        { name: "n8n", icon: "https://ext.same-assets.com/1282326863/3221132930.png" },
      ],
    },
  ];
